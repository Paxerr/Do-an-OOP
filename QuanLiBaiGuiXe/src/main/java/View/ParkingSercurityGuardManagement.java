...
public class ParkingSercurityGuardManagement extends JFrame {
    ...
    public ParkingSercurityGuardManagement(String username, String role) {
        ...
        addBtn.addActionListener(e -> {
            ...
            String roleInput = roleCombo.getSelectedItem().toString();
            String birthDate = birthDateField.getText().trim();
            String gender = genderCombo.getSelectedItem().toString();
            String address = addressField.getText().trim();
            String phone = phoneField.getText().trim();

            if (cccd.isEmpty() ||name.isEmpty() ||birthDate.isEmpty() || address.isEmpty() || phone.isEmpty()) {
                JOptionPane.showMessageDialog(this, "Vui lòng điền đầy đủ thông tin!", "Lỗi", JOptionPane.ERROR_MESSAGE);
                return;
            }

            sercurityGuardsList.add(new Object[]{id,cccd,name, roleInput, birthDate, gender, address, phone});
