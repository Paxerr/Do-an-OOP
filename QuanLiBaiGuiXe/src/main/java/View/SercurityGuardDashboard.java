...
public class SercurityGuardDashboard extends JFrame {
    ...
    public SercurityGuardDashboard(String username, String role) {
        ...
        vehicleAddBtn.addActionListener(e -> {
            String licensePlate = vehiclePlateInputField.getText().trim();
            ...
            if (licensePlate.isEmpty() &&(type.equals("Xe máy")||(type.equals("Ô tô")))) {
                JOptionPane.showMessageDialog(this, "Vui lòng điền đầy đủ thông tin!", "Lỗi", JOptionPane.ERROR_MESSAGE);
                return;
            }
            
            vehiclesList.add(new Object[]{id, licensePlate, type, type, fullEntryTime});
        ...
        monthlyCardAddBtn.addActionListener(e -> {
            ...
            if (ticketId.isEmpty() ||fee.isEmpty()||(licensePlate.isEmpty() &&(type.equals("Xe máy")||(type.equals("Ô tô"))))) {
                JOptionPane.showMessageDialog(this, "Vui lòng điền đầy đủ thông tin!", "Lỗi", JOptionPane.ERROR_MESSAGE);
                return;
            }
